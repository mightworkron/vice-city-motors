...
const CollisionRepair = () => {
  const benefits = [
    ...
    "OEM and aftermarket parts availability",
    "Advanced paint matching technology",
      ...
      <section className="py-16 miami-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Assessment", desc: "Detailed damage evaluation and estimate" },
              { step: "02", title: "Planning", desc: "Custom repair plan and timeline creation" },
              { step: "03", title: "Execution", desc: "Expert repair work and quality checks" },
              { step: "04", title: "Delivery", desc: "Final inspection and vehicle return" }
            ].map((item, index) => (
