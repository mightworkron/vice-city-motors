    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl display-text font-black mb-6">
            <span className="bold-neon animate-neon-glow">THE SHOWROOM</span>
            <br />
            <span className="text-white font-bungee">MIAMI</span>
          </h1>
          
          <p className="text-xl sm:text-2xl neon-text-cyan font-russo font-bold mb-4 tracking-wider">
            MIAMI'S AUTO SOURCE SINCE 2018
          </p>
          
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed font-rajdhani font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Button 
              size="lg" 
              className="cta-button bg-gradient-to-r from-neon-pink to-neon-purple hover:from-neon-purple hover:to-neon-blue text-white px-8 py-4 rounded-lg neon-border transition-all duration-300 transform hover:scale-105 retro-glow"
            >
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="cta-button border-neon-cyan text-neon-cyan hover:bg-neon-cyan hover:text-black px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105"
            >
              GET CUSTOM BUILD
          ...
          <a 
            ...
            className="text-2xl font-russo font-bold neon-text-cyan hover:text-neon-pink transition-colors duration-300 animate-float tracking-wider"
          >
            305-419-8379
          </a>
        </div>
      ...
      <section className="py-20 miami-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bungee font-bold mb-6">
                <span className="neon-text">CRAFTING EXCELLENCE</span>
                <br />
                <span className="text-white">SINCE 2018</span>
              </h2>
              <p className="text-lg text-gray-300 mb-6 leading-relaxed font-rajdhani font-medium">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bungee font-bold mb-4">
              <span className="neon-text">OUR SERVICES</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto font-rajdhani font-medium">
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-russo font-bold text-white mb-3 group-hover:text-neon-pink transition-colors duration-300 tracking-wide">
                    {service.title}
                  </h3>
                  <p className="text-gray-300 mb-4 leading-relaxed font-rajdhani">
                    {service.description}
                  </p>
                  <div className="flex items-center text-neon-cyan group-hover:text-neon-pink transition-colors duration-300 font-russo font-medium tracking-wide">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed font-rajdhani font-medium">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-white font-russo font-bold tracking-wide">CALL US</p>
                    <a href="tel:305-419-8379" className="text-neon-cyan hover:text-neon-pink transition-colors duration-300 font-russo tracking-wide">
                      305-419-8379
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-white font-russo font-bold tracking-wide">VISIT US</p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-white font-russo font-bold tracking-wide">BUSINESS HOURS</p>
            ...
            <div className="bg-card rounded-lg p-8 border border-neon-purple/30">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit"
                  className="w-full cta-button bg-gradient-to-r from-neon-pink to-neon-purple hover:from-neon-purple hover:to-neon-blue text-white py-3 rounded-lg transition-all duration-300 retro-glow"
                >
                  SEND MESSAGE
                </Button>
              </form>
