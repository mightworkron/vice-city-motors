...
const ExoticRentals = () => {
  const features = [
    "Curated fleet of exotic and luxury vehicles",
    ...
    "Special event and wedding packages"
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-card rounded-lg p-8 border border-neon-purple/30">
              ...
              <div className="space-y-6">
                {[
                  { step: "1", title: "Choose Your Vehicle", desc: "Browse our fleet and select your dream car" },
                  { step: "2", title: "Book & Confirm", desc: "Secure your rental with easy online booking" },
                  { step: "3", title: "Delivery Setup", desc: "Schedule convenient delivery to your location" },
                  { step: "4", title: "Drive & Enjoy", desc: "Experience luxury with 24/7 concierge support" }
                ].map((item, index) => (
